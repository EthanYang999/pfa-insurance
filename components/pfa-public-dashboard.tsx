          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-pfa-royal-blue leading-tight">
                AI保险
                <span className="text-pfa-champagne-gold">教练</span>
                <br />专业卓越
              </h1>
              ...
              <div className="bg-gradient-to-br from-pfa-royal-blue to-pfa-navy-blue rounded-2xl p-8 shadow-2xl">
                <div className="bg-white rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-pfa-royal-blue">AI实战教练</h3>
                      <p className="text-sm text-pfa-dark-gray">在线</p>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="bg-pfa-light-gray rounded-lg p-3">
                      <p className="text-sm text-pfa-dark-gray">您好！我是AI实战教练，随时为您提供专业指导。</p>
                    </div>
            ...
            {[
              {
                ...
                title: 'AI智能对话',
                desc: '24/7在线AI教练，随时解答您的专业问题，提供个性化指导建议'
              },
              {
                icon: <BookOpen className="h-8 w-8" />,
                title: '专业知识库',
                desc: '涵盖产品知识、销售技巧、法规政策等全方位保险专业内容'
              },
              {
                icon: <Target className="h-8 w-8" />,
                title: '销售技能提升',
                desc: '系统化的销售话术训练，客户沟通技巧，成单率显著提升'
              },
              {
                icon: <Users className="h-8 w-8" />,
                title: '团队协作',
                desc: '资源共享平台，团队经验交流，共同成长共创佳绩'
              },
              {
                icon: <TrendingUp className="h-8 w-8" />,
                title: '业绩分析',
                desc: '智能数据分析，业绩追踪，为您制定个性化的提升方案'
              },
              {
                icon: <Award className="h-8 w-8" />,
                title: '专业认证',
                desc: '完整的培训认证体系，助您获得行业认可的专业资质'
              }
            ].map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent>
                  <p className="text-pfa-dark-gray text-center">{feature.desc}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section id="concept" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-pfa-dark-gray max-w-3xl mx-auto">
              独特的保险经营理念，以创新科技赋能传统保险业务，实现客户、经纪人、公司的三方共赢
            </p>
          </div>
      ...
      <section id="opportunity" className="py-24 bg-gradient-to-br from-pfa-royal-blue/10 to-pfa-navy-blue/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-pfa-dark-gray max-w-3xl mx-auto">
              加入我们的团队，开启您的保险事业新篇章。我们提供完整的培训体系、
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-pfa-champagne-gold">
                ...
                <p className="text-pfa-dark-gray italic mb-4">
                  &ldquo;一个人走得快，一群人走得远。在这里，我们不仅仅是同事，更是相互支撑的伙伴和朋友。&rdquo;
                </p>
                <p className="text-pfa-royal-blue font-semibold">— 核心理念</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              {
                name: "李经理",
                role: "资深保险顾问",
                story: "从零基础到年度销售冠军，在专业培训和AI实战教练指导下，一年内业绩提升300%，成功帮助200多个家庭建立完善的保障规划。",
                achievement: "年度销售冠军"
              },
              {
                name: "王团队长",
                role: "区域团队领导",  
                story: "通过平台的团队管理培训，从个人顾问成长为优秀的团队领导者，带领30人团队创造了区域业绩第一的佳绩。",
                achievement: "优秀团队领导者"
              },
              {
                name: "张经纪人",
      ...
      <section className="py-24 bg-gradient-to-r from-pfa-royal-blue to-pfa-navy-blue">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-xl text-pfa-champagne-gold">
            立即体验AI实战教练，获得个性化的专业指导，让您的保险事业更上一层楼
          </p>
          <div className="mt-8">
            <Button 
              onClick={() => navigateToProtectedRoute(router, '/chat')}
